...
public class IPerfProperties
{
	...
	public static final int DEFAULT_LISTEN_PORT = 5201;

	public static final String KEY_REVERSE = "reverse";
	public static final boolean DEFAULT_REVERSE_ENABLED = false;
	...
	public static final String KEY_OMIT = "omit-value";
	public static final int DEFAULT_OMIT = 2;
	...
	public static final int DEFAULT_TEST_MODE_PORT = 5201;
	...
	public IPerfProperties(boolean putDefaultValues)
	{
		if (putDefaultValues)
		{
			...
			put(KEY_REVERSE, DEFAULT_REVERSE_ENABLED);
